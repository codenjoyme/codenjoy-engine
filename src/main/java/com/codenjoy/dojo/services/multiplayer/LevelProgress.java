...
public class LevelProgress {
    ...
    /**
     * Счет уровней в настройках хранятся, начиная с номера 1,
     * счет же у нормальных программистов ведется начиная от 0.
     * Я пробовал нормально - путаница получается, лучше так, поверь.
     *
     * Эта константа тут, чтобы связать все места в коде (java + js),
     * где счет ведем от 1. А имя у нее такое замысловатое, чтобы легко
     * было по Ctrl-F найти во всех местах проекта.
     *
     * Подробнее смотри git commit: e26ec4f6.
     *
     * Чувствуешь силу? Попробуй порефактори, чтобы клиенту
     * виделись номера (от 1), а в коде везде были индексы (от 0).
     */
